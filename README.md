...
2. Clone this repository -
   ```sh
   git clone https://github.com/zij-jahidul/react-redux-chatting-application.git
   ```
3. Go to the cloned project directory
   ```sh
   cd react-redux-chatting-application
   ```
...
[facebook-url]: https://www.facebook.com/safzij
...
[mail-shield]: https://img.shields.io/badge/%F0%9F%93%A7%20Email-safzahidul.cse%40gmail.com-lightgray
[mail-url]: mailto:safzahidul.cse@gmail.com
